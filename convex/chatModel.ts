...
},
{
    ...
    id: "openai/gpt-4o",
    name: "GPT-4o",
    description: "Multimodal AI optimized for speed, excelling at text, vision, and audio.",
}, {
    id: "openai/gpt-4o-mini",
    name: "GPT-4o Mini",
    description: "Fast and affordable multimodal model for everyday tasks.",
}, {
    id: "openai/gpt-4o-turbo",
    name: "GPT-4o Turbo",
    description: "Enhanced GPT-4o with improved speed and extended context.",
}, {
    ...
    description: "Balanced performance model with strong reasoning and safety.",
}, {
    ...
    description: "Fast reasoning model optimized for quick analytical thinking.",
}, {

    id: "deepseek/deepseek-v3.1",
    name: "DeepSeek V3.1",
    description: "Advanced reasoning model with exceptional problem-solving skills.",
}, {
    id: "deepseek/deepseek-v3.2-exp-thinking",
    name: "DeepSeek V3.2 Exp Thinking",
    description: "Extended thinking model for complex reasoning and analysis.",
}, {
